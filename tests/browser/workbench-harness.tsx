// Real workbench, editor, and terminal; deterministic native IPC at the boundary.
// This entry point is only served by Vite's test server, never bundled in the app.
