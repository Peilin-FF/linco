...
\def\markdownRendererErrorPrototype#1#2#3#4{%
  \markdownError{#2}{#4}}%
\def\markdownRendererBracketedSpanPrototype#1{#1}%
\def\markdownRendererInlineHtmlProcessingInstructionPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInlineHtmlDeclarationPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInlineHtmlCdataSectionPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInlineHtmlOpenTagPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInlineHtmlCloseTagPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInlineHtmlEmptyTagPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\def\markdownRendererInputBlockHtmlCdataElementPrototype{%
  \markdownRendererInputBlockHtmlElementPrototype}%
\def\markdownRendererInputBlockHtmlProcessingInstructionPrototype{%
  \markdownRendererInputBlockHtmlElementPrototype}%
\def\markdownRendererInputBlockHtmlDeclarationPrototype{%
  \markdownRendererInputBlockHtmlElementPrototype}%
\def\markdownRendererInputBlockHtmlCdataSectionPrototype{%
  \markdownRendererInputBlockHtmlElementPrototype}%
\def\markdownRendererInputBlockHtmlPcdataElementPrototype{%
  \markdownRendererInputBlockHtmlElementPrototype}%
\def\markdownRendererBlockHtmlCommentPrototype{%
  \markdownRendererInlineHtmlCommentPrototype}%
\def\markdownRendererBlockHtmlStandaloneTagPrototype{%
  \markdownRendererInlineHtmlTagPrototype}%
\ExplSyntaxOn
\cs_new:Nn
...
\cs_new_protected:Nn \__markdown_jekyll_data_concatenate_address:NN
  {
    \seq_pop_left:NN #1 \l_tmpa_tl
    \tl_set:Nx #2 { / \seq_use:Nn #1 { / } }
    \seq_put_left:NV #1 \l_tmpa_tl
  }
\cs_new_protected:Nn \__markdown_jekyll_data_update_address_tls:
  {
...
\cs_new_protected:Nn \__markdown_jekyll_data_push:nN
  {
...
\cs_new_protected:Nn \__markdown_jekyll_data_pop:
  {
    \seq_pop_right:NN
      \g__markdown_jekyll_data_wildcard_absolute_address_seq
      \l_tmpa_tl
...
\cs_new_protected:Nn \__markdown_jekyll_data_set_keyval_known:nn
  {
    \keys_set_known:nn
      { markdown/jekyllData }
      { { #1 } = { #2 } }
...
\cs_generate_variant:Nn
  ...
  { Vn }
\cs_new_protected:Nn \__markdown_jekyll_data_set_keyvals_known:nn
  {
