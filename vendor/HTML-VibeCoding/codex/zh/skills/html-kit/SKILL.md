---
name: html-kit
description: 产出自包含 HTML 产物/报告/对比/图表/讲解/原型/编辑器,或做 Linco notebook,或使用 HTML 设计组件(卡片、callout、指标卡、pro/con、file-diff、时间线、badge 等)时使用。提供设计套件(配色 token、排版)、notebook 模板、组件清单与就地答复工作流。
---
